...
SALARY_DATA_PATH = PROJECT_ROOT / "TestData" / "addYesBankBeneSalary.json"
...
@pytest.mark.parametrize(
    ...
    ids=lambda data: data.get("case_id", data.get("empNickName", "salary_bene")),
)
def test_add_yes_bank_bene_salary(page, base_url, login_data, salary_data):
    ...
    add_salary_bene = AddYesBankBeneSalaryPage(page)
    add_salary_bene.add_yes_bank_bene_salary(salary_data)
